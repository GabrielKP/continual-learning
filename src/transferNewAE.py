...
from ae_new import get_model, freezeParameters, unfreezeParameters, reInitParameters
...
def main():                     # Best values so far
    ...
    # Get Model
    model, opt = get_model(input_dim, embedding_dim, hidden_dim, intermediate_dim, n_layers, dropout, lr, bidirectional)
